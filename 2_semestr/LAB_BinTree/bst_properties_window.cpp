...
BST_Properties_Window::BST_Properties_Window(QWidget *parent) : QMainWindow(parent)
{
    ...
    heightLabel = new QLabel("Высота:");
    nodeCountLabel = new QLabel("Количество узлов:");
    leafNodesLabel = new QLabel("Количество \"листьев\":");
    internalNodesLabel = new QLabel("Внутренние узлы:");
    ...
    exitButton = new QPushButton("В&ыход", this);
    connect(exitButton, SIGNAL(clicked()), this, SLOT(exitSlot()));
    findButton=new QPushButton("П&оиск", this);
    ...
    mainLayout->addWidget(new QLabel("Поиск элемента по ключу"));
